  ...
  return (
    <main className="min-h-screen bg-[#000000] font-sans selection:bg-[#D1F843] selection:text-black relative">
      ...
      <section className={`${getBgColor()} rounded-b-[3rem] px-8 py-10 md:px-16 md:py-12 relative overflow-hidden transition-colors duration-700 ease-in-out`}>
        ...
        <div className={`grid grid-cols-1 lg:grid-cols-12 gap-8 relative z-10 transition-all duration-1000 ease-in-out ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
      ...
      <div className={`transition-all duration-1000 ease-in-out delay-300 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
